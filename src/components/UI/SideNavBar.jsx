      ...
      >
        <ul className="menu">
          ...
          <li
            className={
              "menu-item" +
              (location.pathname === "/vest-token" ? " active" : "")
            }
          >
            <Link className="menu-item-link" to={"/vest-token"}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
                height="20"
          ...
          <li
            className={
              "menu-item" +
              (location.pathname === "/vest-token-list" ? " active" : "")
            }
          >
            <Link className="menu-item-link" to={"/vest-token-list"}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
                height="20"
          ...
          <li
            className={
              "menu-item" +
              (location.pathname === "/tradable-vest-token" ? " active" : "")
            }
          >
            <Link className="menu-item-link" to={"/tradable-vest-token"}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
                height="20"
          ...
          <li
            className={
              "menu-item" +
              (location.pathname === "/tradable-vest-list" ? " active" : "")
            }
          >
            <Link className="menu-item-link" to={"/tradable-vest-list"}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
                height="20"
          ...
          <li
            className={
              "menu-item" +
              (location.pathname === "/bulk-transfer" ? " active" : "")
            }
          >
            <Link className="menu-item-link" to={"/bulk-transfer"}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
                height="20"
