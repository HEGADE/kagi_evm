    ...
    <header className="header">
      ...
      <div className="header-actions search-bar">
        <div className="interactive-input dark">
          <input type="text" id="search-main" name="search_main" placeholder="Search..." />
      ...
      <div className="header-actions">
        {
          !userSession.isUserSignedIn() && <button className="button primary wallet-connect" onClick={authenticate}>Connect Wallet</button>
        }
        {
          !!userSession.isUserSignedIn() && <button className="button primary wallet-connect" onClick={disconnect}>{shortAddress(userSession.loadUserData().profile.stxAddress.testnet, 8)}</button>
        }
        <div className="action-list">
          <div className="action-list-item-wrap">
            <div className="action-list-item header-dropdown-trigger ">
              <svg xmlns="http://www.w3.org/2000/svg" style = {{ width: "20", height: "20", fill: "#fff", viewBox: "0 0 16 16" }} className="bi bi-moon theme-color" >
